...
pub const DesktopBindings = struct {
    ...
    switch_to: [9]KeyChord = .{
        .{ .key_code = 18, .modifiers = mod_option },
        .{ .key_code = 19, .modifiers = mod_option },
        .{ .key_code = 20, .modifiers = mod_option },
        .{ .key_code = 21, .modifiers = mod_option },
        .{ .key_code = 23, .modifiers = mod_option },
        .{ .key_code = 22, .modifiers = mod_option },
        .{ .key_code = 26, .modifiers = mod_option },
        .{ .key_code = 28, .modifiers = mod_option },
        .{ .key_code = 25, .modifiers = mod_option },
    },
    move_to: [9]KeyChord = .{
